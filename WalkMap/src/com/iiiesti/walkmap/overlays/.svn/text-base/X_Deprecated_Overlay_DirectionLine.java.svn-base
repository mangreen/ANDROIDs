...
public class X_Deprecated_Overlay_DirectionLine extends Overlay{
	/* Constants */
	...
	/** Constructor */
	public X_Deprecated_Overlay_DirectionLine(Context context, MapView mapView) {
		mMapView = mapView;
		...
		paints[Direction_Constant.TRAVEL_MODE_MT].setColor(0x99990000);
	}
