package com.iiiesti.pedestrian.pmap.database;
...
public class BookmarkDBManager {
	...
	private static class DBOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE simple_points(_id INTEGER PRIMARY KEY,name TEXT,info TEXT,longitude INTEGER NOT NULL,latitude INTEGER NOT NULL,addr_longitude INTEGER NOT NULL,addr_latitude INTEGER NOT NULL)");
	...
	public long SPOINT_insert(String name, String info, int latE6, int lonE6, int addrLatE6, int addrLonE6)
	{
		ContentValues cv = new ContentValues();
	...
	public void SPOINT_update(long _id, String name, String info, int latE6, int lonE6, int addrLatE6, int addrLonE6)
	{
		ContentValues cv = new ContentValues();
		cv.put(SPOINT_FIELD_NAME, name);
		cv.put(SPOINT_FIELD_INFO, info);
